...
<body>
    ...
    <h1>Marcar Borrar Instalaciones</h1>
...
<form id="myFormBorrar" action="back.jsp" method="post">
    <!-- Campo de entrada oculto para enviar la cadena generada -->
    <input type="hidden" id="idsMarcadosInput" name="idsMarcadosInputBorrar">
    <input type="hidden" id="codigo" name="codigo" value="1">
...
<script>
    ...
    function aplicarFiltro() {
          ...
          for (let i = 1; i < filas.length; i++) {
                ...
                // Comprobar filtros
                if (pais.includes(filtroP) && ciudad.includes(filtroC) && instalacion.includes(filtroI) && (!isNaN(filtroNumID) ? id === filtroNumID : true) && rev == "true" ) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    checkboxes.forEach(function(checkbox) {
        checkbox.addEventListener("change", function() {
            ...
            if (isPendiente){
            // marca a 0 para que el espacio no cuente
                espacioValue=0;
            }
